    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            >
                ...
                <span className="text-sm font-medium text-gray-700">{currentModeConfig.label}</span>
                <svg
                    ...
                    {VIEW_MODES.map((mode) => (
                        <button
                            ...
                            className={`w-full flex items-center gap-3 px-4 py-3 text-left hover:bg-gray-50 transition-colors ${
                                currentMode === mode.id ? 'bg-blue-50' : ''
                            }`}
                            role="option"
                        ...
                        >
                            ...
                            <span className={`text-sm ${currentMode === mode.id ? 'font-semibold text-blue-700' : 'text-gray-700'}`}>
                                {mode.label}
                            </span>
                        </button>
                    ))}
